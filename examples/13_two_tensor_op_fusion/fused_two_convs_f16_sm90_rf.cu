...
cutlass::conv::Conv2dProblemSize conv2d_f16_sm90_problem_size_0 (
...
cutlass::conv::Conv2dProblemSize conv2d_f16_sm90_problem_size_1 (
    {32, 56, 56, 64},    // input size (NHWC)
...
bool run_nonfused_conv2d_fprop_optimized_f16_sm90() {
  ...
  bool pass = nonFusedConv2d.run(conv2d_f16_sm90_problem_size_0, conv2d_f16_sm90_problem_size_1, cutlass::conv::SplitKMode::kSerial,
...
bool run_fused_conv2d_fprop_optimized_f16_sm90_rf_res() {
  using ElementA           = cutlass::half_t; 
  using ElementB           = cutlass::half_t; 
  using ElementC           = cutlass::half_t; 
  using ElementAccumulator = cutlass::half_t; 
  ...
  bool pass = fusedConv2d.run(conv2d_f16_sm90_problem_size_0, conv2d_f16_sm90_problem_size_1, cutlass::conv::SplitKMode::kSerial,
      alpha0, beta0, alpha1, beta1);
...
int main() {
  ...
  std::vector<bool (*)()>funcs = {
    &run_nonfused_conv2d_fprop_optimized_f16_sm90,
    &run_fused_conv2d_fprop_optimized_f16_sm90_rf_res
  };

  return testRun(90, funcs, "conv f16 RF residency");
